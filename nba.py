...
def getTeamStatsByYear(year):
    ...
    for x in range(30):
        rawTeamName = soup[soup.find('data-idx="' + str(x) + '">') : soup.find('data-idx="' + str(x) + '">') + 500]
        ...
        rawTeamWins = soup[soup.find('data-idx="' + str(x) + '"><td class="Table2__td"><span') : soup.find('Table2__even" data-idx="' + str(x) + '"><td class="Table2__td"><span') + 1000]
        teamWins = float(rawTeamWins[rawTeamWins.find('stat-cell">') + 11 : rawTeamWins.find('</span></td><td class')])
